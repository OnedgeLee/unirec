...
class Encodable(Versioned, Generic[TContext]):
    ...
    def __init__(
        ...
        self._vec_enc_cached: dict[tuple[str, str], Tensor] = {}
    ...
    def cache(
        ...
        self._vec_enc_cached[
            (self._fingerprinter.key(encoder), self._fingerprinter.key(request))
        ] = vec_enc
    ...
    def get_vec_enc_cached(
        self, encoder_key: str, request_key: tuple[str, str] | None
    ) -> Tensor | None:
